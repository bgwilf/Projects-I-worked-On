...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		/*
		 * Get user input for game type "Player vs. Player"
		 */
		Object[] options = {"2players-VS","RandomMoves(AI)","Min-Max(AlphaBeta)" };
		...
		text.setText("Let's Play Chess: " + options[n] + " style.  Enjoy!");
